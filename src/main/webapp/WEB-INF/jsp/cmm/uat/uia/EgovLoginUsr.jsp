                ...
                <div id="content_img_div"><img  alt="LOGIN 표준프레임워크 경량환경 단순 홈페이지에 오신것을 환영합니다." src="<c:url value='/'/>images/subtitle/img_subtitle_login.gif" width="776" height="230" /></div>       
                    <div class="user_login">
                        ...
                        <div class="user_login_btstyle">
                         ...
                         -->
                        <!-- 회원가입 버튼 -->
						<div style="margin-top: 20px; text-align: left;" class="signup-buttons">
						    <button type="button" onclick="location.href='<c:url value="/cmm/uat/uia/registerGnr.do"/>'">일반회원가입</button>
						    <button type="button" onclick="location.href='<c:url value="/cmm/uat/uia/registerEmp.do"/>'">직원 회원가입</button>
						</div> 
                    </div>
            </div>                      
            <!-- //content 끝 -->    
