...
<script type="text/javascript">
    function fn_main_headPageAction(menuNo, url) {
        ...
        form.setAttribute("action", "<c:url value='/cmm/forwardPage.do'/>");

        var inputMenuNo = document.createElement("input");
        inputMenuNo.setAttribute("type", "hidden");
        inputMenuNo.setAttribute("name", "menuNo");
        inputMenuNo.setAttribute("value", menuNo);
        form.appendChild(inputMenuNo);
