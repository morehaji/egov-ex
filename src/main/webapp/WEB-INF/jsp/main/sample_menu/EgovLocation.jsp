		...
		<!-- //좌측메뉴 끝 -->
			...
			<div id="content">
				...
				<div class="content_field">
						...
						<p style="text-align: center; margin-top: 10px; font-weight: bold;">📍 부산역</p>
							<h3>무교청사 찾아 오시는 길 </h3>
...
<!-- //전체 레이어 끝 -->
<script src="https://dapi.kakao.com/v2/maps/sdk.js?appkey=aa25e4e76636ec15b0e97ef5a6860050"></script>
<script>
	window.onload = function() {
		
		var container = document.getElementById('map');
		var options = {
			center: new kakao.maps.LatLng(35.1151, 129.0415),
			level: 3
		};
		...
		// 마커가 표시될 위치
	    var markerPosition  = new kakao.maps.LatLng(35.1151, 129.0415);
	    ...
	    var infowindow = new kakao.maps.InfoWindow({
	        content: '<div style="padding:5px;font-size:16px;">부산역</div>'
	    });
